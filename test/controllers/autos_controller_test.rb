...
class AutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auto" do
    assert_difference('Auto.count') do
      post autos_url, params: { auto: { anio: @auto.anio, marca: @auto.marca, modelo: @auto.modelo } }
    end
  ...
  test "should update auto" do
    patch auto_url(@auto), params: { auto: { anio: @auto.anio, marca: @auto.marca, modelo: @auto.modelo } }
